...
abstract contract Ethereum_Activate_MegaEth_Bridge_Adapter_Payload is BaseDeployerScript {
  ...
  function PAYLOAD_SALT() internal pure virtual returns (string memory) {
    return 'Add MegaEth path to a.DI';
  }
  ...
  function _execute(Addresses memory addresses) internal virtual override {
    ...
    _deployPayload(
      AddForwarderAdapterArgs({
        ...
        destinationChainBridgeAdapter: destinationAddresses.megaethAdapter,
