...
abstract contract Ethereum_Activate_Bob_Bridge_Adapter_Payload is BaseDeployerScript {
  ...
  function _execute(Addresses memory addresses) internal virtual override {
    ...
    _deployPayload(
      AddForwarderAdapterArgs({
        ...
        destinationChainBridgeAdapter: destinationAddresses.bobAdapter,
