...
import '../../../../src/adapter_payloads/Ethereum_Plasma_Path_Payload.sol';

abstract contract Ethereum_Activate_Plasma_Bridge_Adapter_Payload is BaseDeployerScript {
  ...
  function PAYLOAD_SALT() internal pure virtual returns (string memory) {
    return 'Add path to a.DI for Plasma';
  }
